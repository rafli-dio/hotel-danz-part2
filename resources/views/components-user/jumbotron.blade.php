<div class="container mx-auto px-4 lg:px-6 py-2.5 mt-[60px] flex flex-col lg:flex-row justify-between items-center">
    ...
    <section class="description-jumbotron w-full lg:w-[40%] p-[60px]">
        <h1 class="text-[70px] font-bold">
            Let's <br><u class="decoration-orange-500">travel</u> the<br>world
        </h1>
        <p class="mt-6">
            Nikmati liburan menyenangkan dan menginap nyaman di Hotel
            <span class="text-blue-700 font-bold">Danz</span>.
        </p>
    </section>
    ...
    <section class="image-jumbotron w-full lg:w-[50%] p-4">
        <div class="grid grid-cols-2 gap-4">
            <div>
                <img src="{{ asset('assets/images/gambar-hotel-2.jpg') }}" alt="Gambar Kedua"
                    class="w-full h-full object-cover rounded-lg">
            </div>
            <div class="row-span-2">
                <img src="{{ asset('assets/images/gambar-hotel-1.jpeg') }}" alt="Gambar Utama"
                    class="w-full h-full object-cover rounded-lg">
            </div>
            <div>
                <img src="{{ asset('assets/images/gambar-hotel-3.jpg') }}" alt="Gambar Ketiga"
                    class="w-full h-full object-cover rounded-lg">
            </div>
        </div>
    </section>
...
<!-- Booking Section -->
<section class="booking-jumbotron w-[90%] lg:w-[80%] mx-auto bg-white rounded-xl lg:rounded-full shadow-lg p-6">
    <div class="booking p-4">
        <form class="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div class="relative w-full lg:w-[200px]">
                ...
                <input type="number" min="1" placeholder="Jumlah orang"
                    class="p-2 pl-10 border rounded-xl bg-gray-200 w-full">
            </div>

            <!-- Search Button -->
            <div class="flex items-center w-full lg:w-auto">
                <button type="submit"
                    class="flex items-center justify-center gap-2 px-6 py-3 bg-black text-white rounded-full w-full lg:w-[200px] hover:bg-blue-700">
